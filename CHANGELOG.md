...
## 1.5.2 — 2026-09-20
- Providers, answer validation and the text helper now come from [jev-dev-kit](https://github.com/chy4pro/jev-dev-kit) 0.1.3, the framework extracted from this extension. Behaviour is unchanged; the extension keeps its own action space, rules and Chrome-specific loop.
